...
import ml.windleaf.cuteauth.commands.LoginCommand;
import ml.windleaf.cuteauth.commands.RegisterCommand;
import ml.windleaf.cuteauth.events.PlayerQuit;
import ml.windleaf.cuteauth.forbidden.*;
import ml.windleaf.cuteauth.schedules.autologin.ThreadSchedule;
import ml.windleaf.cuteauth.utils.Utils;
import ml.windleaf.cuteauth.commands.CuteAuthCommand;
import ml.windleaf.cuteauth.commands.LogoutCommand;
import ml.windleaf.cuteauth.events.PlayerJoin;
import ml.windleaf.cuteauth.filters.ConsoleFilter;
import ml.windleaf.cuteauth.filters.Log4jFilter;
import ml.windleaf.cuteauth.managers.DataManager;
import ml.windleaf.cuteauth.managers.LoginMapManager;
import ml.windleaf.cuteauth.managers.LogoutMapManager;
...
public final class CuteAuth extends JavaPlugin {
    ...
    public static ArrayList<String> commands = new ArrayList<>(Arrays.asList("/login", "/l",
                                                                             "/register", "/reg",
                                                                             "/logout", "/lout"));
    public static ml.windleaf.cuteauth.schedules.timeout.ThreadSchedule threadSchedule;
    public static ThreadSchedule autoLoginThreadSchedule;
    ...
    public void onEnable() {
        ...
        if (this.isEnabled()) {
            ...
            for (Player onlinePlayer : Bukkit.getOnlinePlayers()) {
                ...
                threadSchedule = new ml.windleaf.cuteauth.schedules.timeout.ThreadSchedule(onlinePlayer, "&a输入 &b/login <密码> &a登录哦 (๑•.•๑)",
            ...
            Log.console("&a插件加载完咯~ 用时 {0}ms!", (endTime - startTime));
        }
    }
